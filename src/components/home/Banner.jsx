...
export const Banner = () => {
  ...
  return (
    <div
      id="home"
      className="container pt-5 mt-md-5 mt-0 d-flex align-items-center w-100"
    >
      {banner.map((item) => (
        <>
          <div className="row mt-5 pt-4 align-items-center">
            <div className="col-md-6 text-md-start text-center">
              <p className="hello fw-bold" data-aos="fade-right">
                {item.hello}
              </p>
              ...
              <div className="mb-4">
                {item.role.map((role) => (
                  <p
                    className="role text-capitalize d-flex align-items-center justify-content-md-start 
		                	justify-content-center gap-2 mb-1"
                    data-aos="fade-left"
                  >
              ...
              <div className="d-flex align-items-center justify-content-md-start justify-content-center gap-md-5 gap-3">
                {item.done.map((val) => (
                  <>
                    <div
                      className="exper d-flex align-items-center gap-1"
                    ...
                    <div
                      className="project d-flex align-items-center gap-1"
                      data-aos="fade-up-right"
                    >
            ...
            <div className="col-md-6 mt-md-0 mt-5 text-center">
              {item.avatar.map((av) => (
                <Tilt
                  options={options}
                  className="circularAvatar mx-auto d-flex align-items-start 
